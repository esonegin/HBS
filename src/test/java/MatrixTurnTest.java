...
public class MatrixTurnTest {
    ...
    public void ishodnoeShag1() throws Exception {
        //1
        MatrixTurn.MatrixTurn(new String[]{"1234", "5678", "9123", "4567"}, 4, 4, 1);
        String[] actual = MatrixTurn.Matrix;
    ...
    public void ishodnoeShag2() throws Exception {
        //1
        MatrixTurn.MatrixTurn(new String[]{"1234", "5678", "9123", "4567"}, 4, 4, 2);
        String[] actual = MatrixTurn.Matrix;
    ...
    public void ishodnoeShag3() throws Exception {
        //1
        MatrixTurn.MatrixTurn(new String[]{"1234", "5678", "9123", "4567"}, 4, 4, 3);
        String[] actual = MatrixTurn.Matrix;
    ...
    public void ishodnoeShag4() throws Exception {
        //1
        MatrixTurn.MatrixTurn(new String[]{"1234", "5678", "9123", "4567"}, 4, 4, 4);
        String[] actual = MatrixTurn.Matrix;
    ...
    public void ishodnoeShag5() throws Exception {
        //1
        MatrixTurn.MatrixTurn(new String[]{"1234", "5678", "9123", "4567"}, 4, 4, 5);
        String[] actual = MatrixTurn.Matrix;
    ...
    public void light1() throws Exception {
        //1
        MatrixTurn.MatrixTurn(new String[]{"12", "34"}, 2, 2, 1);
        String[] actual = MatrixTurn.Matrix;
    ...
    public void light2() throws Exception {
        //1
        MatrixTurn.MatrixTurn(new String[]{"12", "34"}, 2, 2, 2);
        String[] actual = MatrixTurn.Matrix;
    ...
    public void light3() throws Exception {
        //1
        MatrixTurn.MatrixTurn(new String[]{"12", "34"}, 2, 2, 3);
        String[] actual = MatrixTurn.Matrix;
    ...
    public void light4() throws Exception {
        //1
        MatrixTurn.MatrixTurn(new String[]{"12", "34"}, 2, 2, 4);
        String[] actual = MatrixTurn.Matrix;
    ...
    public void light5() throws Exception {
        //1
        MatrixTurn.MatrixTurn(new String[]{"12", "34"}, 2, 2, 5);
        String[] actual = MatrixTurn.Matrix;
        String[] expected = {"31", "42"};
        Assert.assertThat(actual, is(expected));
    }
    ...
    public void trinadva1() throws Exception {
        //1
        MatrixTurn.MatrixTurn(new String[]{"12", "34", "56"}, 3, 2, 1);
        String[] actual = MatrixTurn.Matrix;
    ...
    public void trinadva2() throws Exception {
        //1
        MatrixTurn.MatrixTurn(new String[]{"12", "34", "56"}, 3, 2, 2);
        String[] actual = MatrixTurn.Matrix;
    ...
    public void trinadva3() throws Exception {
        //1
        MatrixTurn.MatrixTurn(new String[]{"12", "34", "56"}, 3, 2, 3);
        String[] actual = MatrixTurn.Matrix;
    ...
    public void trinadva4() throws Exception {
        //1
        MatrixTurn.MatrixTurn(new String[]{"12", "34", "56"}, 3, 2, 4);
        String[] actual = MatrixTurn.Matrix;
    ...
    public void trinadva5() throws Exception {
        //1
        MatrixTurn.MatrixTurn(new String[]{"12", "34", "56"}, 3, 2, 5);
        String[] actual = MatrixTurn.Matrix;
    ...
    public void trinadva6() throws Exception {
        //1
        MatrixTurn.MatrixTurn(new String[]{"12", "34", "56"}, 3, 2, 6);
        String[] actual = MatrixTurn.Matrix;
    ...
    public void trinadva7() throws Exception {
        //1
        MatrixTurn.MatrixTurn(new String[]{"12", "34", "56"}, 3, 2, 7);
        String[] actual = MatrixTurn.Matrix;
        String[] expected = {"31", "52", "64"};
        Assert.assertThat(actual, is(expected));
    }
    ...
    public void trinadva8() throws Exception {
        //1
        MatrixTurn.MatrixTurn(new String[]{"12", "34", "56"}, 3, 2, 8);
        String[] actual = MatrixTurn.Matrix;
        String[] expected = {"53", "61", "42"};
        Assert.assertThat(actual, is(expected));
    }
    ...
    public void trinadva9() throws Exception {
        //1
        MatrixTurn.MatrixTurn(new String[]{"12", "34", "56"}, 3, 2, 9);
        String[] actual = MatrixTurn.Matrix;
        String[] expected = {"65", "43", "21"};
        Assert.assertThat(actual, is(expected));
    }
    ...
    public void trinadva10() throws Exception {
        //1
        MatrixTurn.MatrixTurn(new String[]{"12", "34", "56"}, 3, 2, 10);
        String[] actual = MatrixTurn.Matrix;
        String[] expected = {"46", "25", "13"};
        Assert.assertThat(actual, is(expected));
    }
    ...
    public void trinadva11() throws Exception {
        //1
        MatrixTurn.MatrixTurn(new String[]{"12", "34", "56"}, 3, 2, 11);
        String[] actual = MatrixTurn.Matrix;
        String[] expected = {"24", "16", "35"};
        Assert.assertThat(actual, is(expected));
    }
    ...
    public void trinadva12() throws Exception {
        //1
        MatrixTurn.MatrixTurn(new String[]{"12", "34", "56"}, 3, 2, 12);
        String[] actual = MatrixTurn.Matrix;
        String[] expected = {"12", "34", "56"};
        Assert.assertThat(actual, is(expected));
    }
    ...
    public void trinadva13() throws Exception {
        //1
        MatrixTurn.MatrixTurn(new String[]{"12", "34", "56"}, 3, 2, 13);
        String[] actual = MatrixTurn.Matrix;
        String[] expected = {"31", "52", "64"};
        Assert.assertThat(actual, is(expected));
    }
    ...
    public void trinadva14() throws Exception {
        //1
        MatrixTurn.MatrixTurn(new String[]{"12", "34", "56"}, 3, 2, 14);
        String[] actual = MatrixTurn.Matrix;
        String[] expected = {"53", "61", "42"};
        Assert.assertThat(actual, is(expected));
    }
